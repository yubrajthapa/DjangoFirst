...
class NewUserForm(UserCreationForm):
    ...
    username = forms.CharField(required=True,  widget=forms.TextInput(attrs={'class':'focus:outline-none','placeholder':'user1'}))
    ...
    class meta:
        model = User
        fields = ('email', 'username', 'passwword1', 'password2')
